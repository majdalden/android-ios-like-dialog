...
public class DialogBottom {
     ...
     */
    public DialogBottom setOnDismissListener(@Nullable DialogInterface.OnDismissListener listener) {
     ...
     */
    public DialogBottom setOnShowListener(@Nullable DialogInterface.OnShowListener listener) {
